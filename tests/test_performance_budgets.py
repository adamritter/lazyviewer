...
from lazyviewer.runtime_tree_filter import TreeFilterOps
...
from lazyviewer.tree import TreeEntry, build_tree_entries
...
class PerformanceBudgetTests(unittest.TestCase):
    ...
    def test_content_search_cache_hit_budget(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch("lazyviewer.runtime_tree_filter.search_project_content_rg", side_effect=slow_search):
